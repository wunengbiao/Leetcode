...
/**
 * Created by wunengbiao on 2017/1/13.
 */
...
//    }
    public static void main(String[] args){
        ...
        int[] test2={0,1,3,5,6,8,12,17};
        int[] test3={0,1,3,6,10,15,16,21};
...
//        String res=s.canCross(stones)?"can":"cannot";
        int[] test5={0,1,3,6,10,13,15,18};
        System.out.println("The fog "+(s.canCross(stones)?"can":"cannot")+" cross the river!");
        System.out.println("The fog "+(s.canCross(test2)?"can":"cannot")+" cross the river!");
        System.out.println("The fog "+(s.canCross(test3)?"can":"cannot")+" cross the river!");
        System.out.println("The fog "+(s.canCross(test4)?"can":"cannot")+" cross the river!");
        System.out.println("The fog "+(s.canCross(test5)?"can":"cannot")+" cross the river!");
